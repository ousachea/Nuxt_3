...
define(['./workbox-d488705a'], (function (workbox) { 'use strict';
  ...
  workbox.precacheAndRoute([{
    ...
    "url": "/",
    "revision": "0.dthi525a2rk"
  }], {});
  workbox.cleanupOutdatedCaches();
  workbox.registerRoute(new workbox.NavigationRoute(workbox.createHandlerBoundToURL("/"), {
    allowlist: [/^\//]
  }));
  workbox.registerRoute(/^https:\/\/api\.gold-api\.com\/.*/i, new workbox.NetworkFirst({
  ...
  workbox.registerRoute(/^https:\/\/www\.goldapi\.io\/.*/i, new workbox.NetworkFirst({

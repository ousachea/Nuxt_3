...
const handlePointerMove = (e: PointerEvent) => {
  ...
  edgeProximity.value = getEdgeProximity(card, e.clientX - rect.left, e.clientY - rect.top);
  cursorAngle.value = getCursorAngle(card, e.clientX - rect.left, e.clientY - rect.top);
};

...
export default defineNuxtConfig({
  ...
  pwa: {
    ...
    devOptions: {
      // Keep the service worker out of the Vite dev graph. Production builds
      // still generate it, while dev avoids stale references when `.nuxt` is
      // regenerated by another Nuxt command.
      enabled: false,
